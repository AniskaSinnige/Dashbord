...
if rad =='Population':
    ...
    if Brazil == False and China == False and Germany == False and Mexico == False and SoutAfrica == False:
        st.plotly_chart(fig)

    if Brazil == True and China == False and Germany == False and Mexico == False and SoutAfrica == False:
        st.plotly_chart(fig1)
    
    if Brazil == False and China == True and Germany == False and Mexico == False and SoutAfrica == False:
        st.plotly_chart(fig2)

    if Brazil == False and China == False and Germany == True and Mexico == False and SoutAfrica == False:
        st.plotly_chart(fig3)
    
    if Brazil == False and China == False and Germany == False and Mexico == True and SoutAfrica == False:
        st.plotly_chart(fig4)
    
    if Brazil == False and China == False and Germany == False and Mexico == False and SoutAfrica == True:
        st.plotly_chart(fig5)
    
    if Brazil == True and China == True and Germany == False and Mexico == False and SoutAfrica == False:
        st.error('Selecteer één optie')
    if Brazil == True and China == False and Germany == True and Mexico == False and SoutAfrica == False:
        st.error('Selecteer één optie')
    if Brazil == True and China == False and Germany == False and Mexico == True and SoutAfrica == False:
        st.error('Selecteer één optie')
    if Brazil == True and China == False and Germany == False and Mexico == False and SoutAfrica == True:
        st.error('Selecteer één optie')
    
    if Brazil == False and China == True and Germany == True and Mexico == False and SoutAfrica == False:
        st.error('Selecteer één optie')   
    if Brazil == False and China == True and Germany == False and Mexico == True and SoutAfrica == False:
        st.error('Selecteer één optie')         
    if Brazil == False and China == True and Germany == False and Mexico == False and SoutAfrica == True:
        st.error('Selecteer één optie') 
        
    if Brazil == False and China == False and Germany == True and Mexico == True and SoutAfrica == False:
        st.error('Selecteer één optie') 
    if Brazil == False and China == False and Germany == True and Mexico == False and SoutAfrica == True:
        st.error('Selecteer één optie') 

    if Brazil == False and China == False and Germany == False and Mexico == True and SoutAfrica == True:
        st.error('Selecteer één optie') 
